...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Basic()
{
    ...
    {
        static const char* const keywords[] = {
            "LIST", "CLEAR", "NEW", "GOTO", "ON", "GOSUB", "RETURN", "RUN", "IF", "THEN",
            "FOR", "TO", "STEP", "NEXT", "END", "STOP", "REM", "DIM", "POKE",
            "LET", "OR", "AND",
            "DATA", "READ", "RESTORE",
            "PRINT", "SPC", "TAB",
            "INPUT", "GET", "LOAD", "SAVE", "DELETE", "DIR",
            "MEM", "SLEEP", "DUMP", "TEST",
        ...
        static const char* const identifiers[] = {
            // Functions
            "LEN","CHR$","MID$","LEFT$","RIGHT$","ASC","VAL","STR$",
            
            // Math
            "ABS", "SIN", "COS", "RND", "INT", "TAN", "SQR",
            "SGN", "LOG", "EXP", "POW", "ATN", "NOT"
        };
